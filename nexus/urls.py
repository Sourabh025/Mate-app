...
urlpatterns = [
    ...
    # path('profile/<int:pk>/',ProfileViewSearch.as_view(),name='profileSearch'),
    # url(r'^', include('django_private_chat.urls')),
    # url('profile/<int:pk>/', s.ProfileView, name='profile_with_pk'),   
    path('profile/<int:pk>/',s.ProfileView,name='profile_with_key'),
    path('messages/', include('chat.urls')),
    path('chat/',include('chat.urls', namespace='chat_index')),
    url(r'^', include('django_private_chat.urls')),
    # path('chat/room',chat.share,name='chat')
]
